    ...
    implements UserInputHandler
{
    ...
    public function get_action_map(MediaURL $media_url, &$plugin_cookies)
    {
        ...
        $move_backward_favorite_action['caption'] = '%tr%caption_backward';

        $move_forward_favorite_action =
            UserInputHandlerRegistry::create_action(
                $this, 'move_forward_favorite');
        $move_forward_favorite_action['caption'] = '%tr%caption_forward';

        $remove_favorite_action =
            UserInputHandlerRegistry::create_action(
                $this, 'remove_favorite');
        $remove_favorite_action['caption'] = '%tr%caption_unfavorite';

        $menu_items[] = array(
            GuiMenuItemDef::caption => '%tr%caption_remove_favourite',
